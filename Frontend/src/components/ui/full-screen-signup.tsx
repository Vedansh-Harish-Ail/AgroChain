    ...
    <div className="min-h-screen  flex items-center justify-center overflow-hidden p-4">
      <div className=" w-full relative max-w-5xl overflow-hidden flex flex-col md:flex-row shadow-xl">
        ...
        <div className="flex absolute z-2  overflow-hidden backdrop-blur-2xl ">
          <div className="h-[40rem] z-2 w-[4rem] bg-gradient-to-r from-transparent via-black to-[#ffffff30] opacity-30 overflow-hidden"></div>
          <div className="h-[40rem] z-2 w-[4rem] bg-gradient-to-r from-transparent via-black to-[#ffffff30]  opacity-30 overflow-hidden"></div>
          <div className="h-[40rem] z-2 w-[4rem] bg-gradient-to-r from-transparent via-black to-[#ffffff30]  opacity-30 overflow-hidden"></div>
          <div className="h-[40rem] z-2 w-[4rem] bg-gradient-to-r from-transparent via-black to-[#ffffff30]  opacity-30 overflow-hidden"></div>
          <div className="h-[40rem] z-2 w-[4rem] bg-gradient-to-r from-transparent via-black to-[#ffffff30]  opacity-30 overflow-hidden"></div>
        ...
        <div className="w-[15rem] h-[15rem] bg-emerald-600 absolute z-1 rounded-full bottom-0"></div>
        ...
        <div className="p-8 md:p-12 md:w-1/2 flex flex-col bg-slate-50 dark:bg-slate-900 z-10 text-slate-900 dark:text-slate-100 ">
          <div className="flex flex-col items-start mb-8">
            <div className="text-emerald-600 mb-4 bg-emerald-500/10 p-2.5 rounded-xl">
          ...
          >
            <div>
              ...
              <input
                ...
                className={`text-sm w-full py-2 px-3 border rounded-lg focus:outline-none focus:ring-1 bg-white text-black focus:ring-emerald-500 ${
            ...
            <div className="text-center text-gray-600 text-sm">
              ...
              <a href="/login" className="text-slate-900 dark:text-slate-100 font-medium underline">
                Login
              </a>
            </div>
          </form>
